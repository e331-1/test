...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var mainArealast=""
    document.getElementsByClassName("mainArea")[0].addEventListener('mouseover', () => {
        ...
        if(device=="pc"&&mainAreaAnimationEnded){
            ...
            var animation=document.getElementsByClassName("mainArea")[0].animate(
                {
                    left: ["72px",`${document.getElementsByClassName("selectArea")[0].clientWidth}px`],
                },
                {
                  // 終了時の状態で止める
                  fill: "forwards",
    ...
    document.getElementsByClassName("mainArea")[0].addEventListener('mouseleave', () => {
        console.log("mouseleave")
        if(device=="pc"&&mainAreaAnimationEnded){
            mainAreaAnimationEnded=false
            var animation=document.getElementsByClassName("mainArea")[0].animate(
                {
                    left: [`${document.getElementsByClassName("selectArea")[0].clientWidth}px`,"72px"],
                },
                {
                  // 終了時の状態で止める
                  fill: "forwards",
