        ...
        pageChanged:function(result){
            ...
            if(result.page==1){
                var animation=document.getElementsByClassName("selectAreaBlur")[0].animate(
                    {
                        backdropFilter: [`blur(${document.getElementsByClassName("selectAreaBlur")[0].style.backdropFilter.match(/[0-9]+|\.+/g).join('')}px)`,`blur(10px)`],
                    },
                    {
                      // 終了時の状態で止める
                      fill: "forwards",
                ...
                var animation=document.getElementsByClassName("selectAreaBlur")[0].animate(
                    {
                        backdropFilter: [`blur(${document.getElementsByClassName("selectAreaBlur")[0].style.backdropFilter.match(/[0-9]+|\.+/g).join('')}px)`,`blur(0px)`],
                    },
                    {
                      // 終了時の状態で止める
                      fill: "forwards",
